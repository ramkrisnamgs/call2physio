...
export default function PhysioSidebar() {
  ...
  const links = [
    {
      href: "/physio/dashboard",
      label: "Dashboard",
      icon: <LayoutDashboard />,
    },
    { href: "/physio/appointments", label: "Appointments", icon: <Calendar /> },
    { href: "/physio/patients", label: "Patients", icon: <UserPlus /> },
    { href: "/physio/earnings", label: "Earnings", icon: <BadgeIndianRupee /> },
    { href: "/physio/documents", label: "Documents", icon: <Album /> },
    { href: "/physio/account", label: "Account", icon: <User /> },
  ];
